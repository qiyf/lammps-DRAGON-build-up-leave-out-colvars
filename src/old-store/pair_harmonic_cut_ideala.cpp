...
#include "stdlib.h"
#include "string.h"
#include "pair_harmonic_cut_ideala.h"
#include "atom.h"
#include "comm.h"
#include "force.h"
#include "neighbor.h"
...
PairHarmonicCutIdeala::PairHarmonicCutIdeala(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 0;
}
...
PairHarmonicCutIdeala::~PairHarmonicCutIdeala()
{
  if (allocated) {
...
void PairHarmonicCutIdeala::compute(int eflag, int vflag)
{
...
void PairHarmonicCutIdeala::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairHarmonicCutIdeala::settings(int narg, char **arg)
{
...
void PairHarmonicCutIdeala::coeff(int narg, char **arg)
{
...
double PairHarmonicCutIdeala::init_one(int i, int j)
{
  // printf("ideala, i is %d, j is %d\n", i,j);
  ...
  // printf("ideala,cut is %f\n",cut[i][j]);
  //   printf("ideala,%d\n", atom->ntypes);
  //   printf("ideala,end init_one\n");
  return cut[i][j];
}
...
void PairHarmonicCutIdeala::write_restart(FILE *fp)
{
...
void PairHarmonicCutIdeala::read_restart(FILE *fp)
{
...
void PairHarmonicCutIdeala::write_restart_settings(FILE *fp)
{
...
void PairHarmonicCutIdeala::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
double PairHarmonicCutIdeala::single(int i, int j, int itype, int jtype, double rsq,
...
/* ---------------------------------------------------------------------- */
double PairHarmonicCutIdeala::memory_usage()
{
