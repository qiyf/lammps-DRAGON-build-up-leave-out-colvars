...
class PairTanhlrCutIdealh : public Pair {
 ...
 protected:
  ...
  // hm_potential2 stands for 0-1
  // hm_potential3 stands for 1-0
  // hm_potential4 stands for 1-1
  // the pseudo diag elements (same histone mark interactions) should be the same
  double ***hm_potential1,***hm_potential2,***hm_potential3,***hm_potential4;
