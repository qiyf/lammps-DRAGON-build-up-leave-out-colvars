...
FixStyle(bond/extrude,FixBondExtrude)

#else

#ifndef LMP_FIX_BOND_EXTRUDE_H
#define LMP_FIX_BOND_EXTRUDE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixBondExtrude : public Fix {
 public:
  FixBondExtrude(class LAMMPS *, int, char **);
  ~FixBondExtrude();
  int setmask();
  void init();
