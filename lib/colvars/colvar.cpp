...
int colvar::init_components(std::string const &conf)
{
  ...
  error_code |= init_components_type<orientation_flexRef>(conf, "orientation " 
          "flexible reference", "orientationFlexRef");
  ...
  error_code |= init_components_type<qbias>(conf, "protein folding "
    "qbias", "qbias");
  error_code |= init_components_type<qinterface>(conf, "protein folding "
    "qinterface", "qinterface");
  error_code |= init_components_type<dhenergy>(conf, "protein dna contact "
    "dhenergy", "dhenergy");
